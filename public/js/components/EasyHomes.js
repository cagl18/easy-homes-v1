      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'listings__found' },
            this.props.globalState.filtered_data.length,
            ' results found'
          ),
          _react2.default.createElement(
            'div',
    ...
    value: function setFilteredData() {
      ...
      if (this.state.finished_basement) {
        newData = newData.filter(function (listing) {
          return listing.amenities.includes('finished_basement');
        });
      }
      if (this.state.gym) {
        newData = newData.filter(function (listing) {
          return listing.amenities.includes('gym');
        });
      }

      if (this.state.swimming_pool) {
        newData = newData.filter(function (listing) {
          return listing.amenities.includes('swimming_pool');
        });
      }

      if (this.state.elevator) {
        newData = newData.filter(function (listing) {
          return listing.amenities.includes('elevator');
        });
      }
